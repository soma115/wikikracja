...
tinyMCE.init({
    ...
    // Init
    mode: 'none',  // https://www.tiny.cloud/docs-3x/reference/Configuration3x/Configuration3x@mode/
    theme: 'silver',
    skin: 'oxide',
    ...
    theme_advanced_buttons1: 'formatselect,styleselect,|,bold,italic,underline,|,bullist,numlist,blockquote,|',
    theme_advanced_buttons2: 'justifycenter,justifyright,justifyfull,|,undo,redo,|,link,unlink,|,image,|,fullscreen,|,grappelli_adv,',
